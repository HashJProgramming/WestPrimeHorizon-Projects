...
!(function () {
  ...
  const Jw = (e, t) => {
    ...
    RE = (e, t, n, o) => (
      ...
      ((e, t) =>
        Sn(t, e)
          ...
          : I.none())(t, n).fold(T(SE, e, t, n, o), T(_E, e, t, n, o))
    ),
    AE = (e, t, n, o, r) => (t ? RE(e, o, n, r) : RE(e, n, o, r)),
    TE = (e, t) => {
      const n = Cn(e.getBody()),
        o = ((e, t, n, o) =>
          o.collapsed
          ...
          (o) => () => {
            AE(n, t, o.from.block, o.to.block, e.schema).each((t) => {
    ...
    BE = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => OE(e, t.startContainer) || OE(e, t.endContainer))(e, t) &&
          n &&
          o
        );
    ...
    PE = (e, t) => (e.selection.isCollapsed() ? I.none() : BE(e)),
    DE = (e, t, n, o, r) => I.from(t._selectionOverrides.showCaret(e, n, o, r)),
    LE = (e, t) =>
      ...
      t.collapsed
        ? ((e, t, n) => {
            const o = pu(1, e.getBody(), t),
              ...
              s = r.getNode();
            if (Wc(s)) return DE(1, e, s, !r.isAtEnd(), !1);
            const a = r.getNode(!0);
            if (Wc(a)) return DE(1, e, a, !1, !1);
            const i = pb(e.dom.getRoot(), r.getNode());
            return Wc(i) ? DE(1, e, i, !1, n) : I.none();
          })(e, t, n).getOr(t)
        : t,
    IE = (e) => Ip(e) || Pp(e),
    FE = (e) => Fp(e) || Dp(e),
    UE = (e, t, n, o, r, s) => {
      DE(o, e, s.getNode(!r), r, !0).each((n) => {
        if (t.collapsed) {
    ...
    zE = (e, t) =>
      ((e, t) => {
        ...
        if (a(d)) return I.some(() => UE(e, n, i.getNode(), o, t, d));
        const c = s(d);
        return c && a(c) && Cu(d, c)
          ? I.some(() => UE(e, n, i.getNode(), o, t, c))
          : I.none();
      })(e, t),
    jE = (e, t) => {
      const n = e.getBody();
    ...
    HE = (e) => {
      ...
      return (
        !t.collapsed &&
        (jE(e, !0).exists((e) => e.isEqual(Qi.fromRangeStart(t))) ||
          jE(e, !1).exists((e) => e.isEqual(Qi.fromRangeEnd(t))))
      );
    },
    $E = xl([
      { remove: ["element"] },
          ...
          ((e, t, n, o, r) => {
            ...
            ? ((e, t, n, o, r) => {
                ...
                return Fh(Cn(t), Cn(o.getNode()))
                  .map((t) =>
                    Tr(e, t) ? $E.remove(t.dom) : $E.moveToElement(s)
                  )
                  .orThunk(() => I.some($E.moveToElement(s)));
              })(o, e, t, n, r)
            : (t && Fp(n)) || (!t && Ip(n))
            ? I.some($E.moveToPosition(r))
            : I.none()
        );
        var s;
      }),
    qE = (e, t) => I.from(pb(e.getBody(), t)),
    WE = (e, t) => {
          ...
          () =>
            ((e, t, n, o) => {
              const r = pu(t ? 1 : -1, e, n),
                ...
                a = Cn(e);
              return !t && Fp(s)
                ? I.some($E.remove(s.getNode(!0)))
                : t && Ip(s)
                ? I.some($E.remove(s.getNode()))
                : !t && Ip(s) && Qp(a, s, o)
                ? Jp(a, s, o).map((e) => $E.remove(e.getNode()))
                : t && Fp(s) && Zp(a, s, o)
                ? eh(a, s, o).map((e) => $E.remove(e.getNode()))
                : ((e, t, n, o) =>
                    ((e, t) => {
                      const n = t.getNode(!e),
                        o = e ? "after" : "before";
                      ...
                      ? ((e, t) =>
                          y(t)
                            ? I.none()
                            : e && vr(t.nextSibling)
                            ? I.some($E.moveToElement(t.nextSibling))
                            : !e && vr(t.previousSibling)
                            ? I.some($E.moveToElement(t.previousSibling))
                      ...
                      : VE(e, t, n, o).bind((t) =>
                          ((e, t, n) =>
                            n.fold(
                              (e) => I.some($E.remove(e)),
                              (e) => I.some($E.moveToElement(e)),
                              (n) =>
                                lu(t, n, e)
                                  ? I.none()
                                  : I.some($E.moveToPosition(n))
                            ))(e, n, t)
                        ))(e, t, s, o);
    ...
    GE = (e) => e.hasOwnProperty("text"),
    XE = (e) => e.hasOwnProperty("marker"),
    ZE = (e, t) => {
      const n = (e, n) => {
    ...
    ex = (e, t) =>
      e.selection.isCollapsed()
        ...
        : I.none(),
    tx = dr,
    nx = (e) => tx(e) && e.data[0] === Qa,
    ox = (e) => tx(e) && e.data[e.data.length - 1] === Qa,
    rx = (e) => {
      var t;
      return (
    ...
    sx = (e, t) =>
      e
        ? ((e) => {
            var t;
            if (tx(e.previousSibling))
              return (
                ox(e.previousSibling) || e.previousSibling.appendData(Qa),
                e.previousSibling
              );
            if (tx(e)) return nx(e) || e.insertData(0, Qa), e;
            {
              const n = rx(e);
              return (
                null === (t = e.parentNode) ||
        ...
        : ((e) => {
            ...
            if (tx(e.nextSibling))
              return (
                nx(e.nextSibling) || e.nextSibling.insertData(0, Qa),
                e.nextSibling
              );
            if (tx(e)) return ox(e) || e.appendData(Qa), e;
            {
              const o = rx(e);
              return (
                e.nextSibling
    ...
    ix = T(sx, !1),
    lx = (e, t) =>
      dr(e.container()) ? sx(t, e.container()) : sx(t, e.getNode()),
    dx = (e, t) => {
      const n = t.get();
    ...
    px = (e, t) => null === Wu(e, t),
    hx = (e, t, n) => Th(e, t, n).filter(T(px, t)),
    bx = (e, t, n) => {
      const o = Ph(n);
      return hx(e, t, o).bind((e) =>
        ju(e, o).isNone() ? I.some(mx.start(e)) : I.none()
      );
    },
    vx = (e, t, n) => {
      const o = Bh(n);
      return hx(e, t, o).bind((e) =>
        zu(e, o).isNone() ? I.some(mx.end(e)) : I.none()
      );
    },
    yx = (e, t, n) => {
      const o = Ph(n),
    ...
    Cx = (e) => !Ah(Ex(e)),
    wx = (e, t, n) => ux([gx, bx, vx, yx], [e, t, n]).filter(Cx),
    Ex = (e) => e.fold(R, R, R, R),
    xx = (e) => e.fold(N("before"), N("start"), N("end"), N("after")),
    kx = (e) => e.fold(mx.before, mx.before, mx.after, mx.after),
    _x = (e) => e.fold(mx.start, mx.start, mx.end, mx.end),
    Sx = (e, t, n, o, r, s) =>
    ...
    Nx = (e, t) =>
      e.fold(M, (e) => {
        return (o = t), !(xx((n = e)) === xx(o) && Ex(n) === Ex(o));
        var n, o;
      }),
    Rx = (e, t) =>
      e
        ? t.fold(_(I.some, mx.start), I.none, _(I.some, mx.after), I.none)
        : t.fold(I.none, _(I.some, mx.before), I.none, _(I.some, mx.end)),
    Ax = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
  ...
  const Ox = (e, t) => (e === wu.Backwards ? oe(t) : t),
    Bx = (e, t, n) => (e === wu.Forwards ? t.next(n) : t.prev(n)),
    Px = (e, t, n, o) =>
      ...
      for (; s; ) {
        ...
        if (pr(n.getNode(!1)))
          return t === wu.Forwards
            ? {
                positions: Ox(t, a).concat([n]),
                breakType: Tx.Br,
                breakAt: I.some(n),
              }
            : { positions: Ox(t, a), breakType: Tx.Br, breakAt: I.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = Px(0, t, s, n);
            return { positions: Ox(t, a), breakType: e, breakAt: I.some(n) };
          }
          a.push(n), (s = n);
        } else s = n;
      }
      return { positions: Ox(t, a), breakType: Tx.Eol, breakAt: I.none() };
    },
    Lx = (e, t, n, o) =>
      t(n, o)
        .breakAt.map((o) => {
    ...
    Ix = (e, t) => le(t.getClientRects()).bind((t) => Mx(e, t.left)),
    Fx = T(Dx, Qi.isAbove, -1),
    Ux = T(Dx, Qi.isBelow, 1),
    zx = T(Lx, -1, Fx),
    jx = T(Lx, 1, Ux),
    Hx = (e, t) => Fx(e, t).breakAt.isNone(),
    $x = (e, t) => Ux(e, t).breakAt.isNone(),
    Vx = (e, t) => Ix(zx(e, t), t),
    qx = (e, t) => Ix(jx(e, t), t),
    Wx = vr,
    Kx = (e, t) => Math.abs(e.left - t),
    Yx = (e, t) => Math.abs(e.right - t),
    Gx = (e, t) =>
      Be(e, (e, n) => {
        const o = Math.min(Kx(e, t), Yx(e, t)),
          r = Math.min(Kx(n, t), Yx(n, t));
        return (r === o && _e(n, "node") && Wx(n.node)) || r < o ? n : e;
      }),
    Xx = (e) => {
      const t = (t) =>
        V(t, (t) => {
  ...
  const Jx = (e, t, n, o, r, s) => {
    ...
    ik = (e, t, n, o, r, s) => {
      ...
      if (!n.collapsed) {
        const o = Ci(n);
        if (s(o)) return DE(t, e, o, t === wu.Backwards, !1);
        if (HE(e)) {
      ...
      if (d(c)) return LE(e, c.getNode(!a));
      let u = l(c);
      const m = mi(n);
      if (!u) return m ? I.some(n) : I.none();
      if (((u = Oh(a, u)), d(u))) return DE(t, e, u.getNode(!a), a, !1);
      const f = l(u);
      return f && d(f) && Cu(u, f)
        ? DE(t, e, f.getNode(!a), a, !1)
        : m
        ? ak(e, u.toRange(), !1)
        : I.none();
    },
    lk = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : Ci(n)), g)) {
        ...
        if (((o = De(Y(n, rk(0)))), o)) return ak(e, o.position.toRange(), !1);
      }
      return 0 === u.length
        ? dk(e, l)
            .filter(l ? r : o)
            .map((t) => ME(e, t.toRange(), !1))
        : I.none();
    },
    dk = (e, t) => {
      const n = e.selection.getRng(),
    ...
    fk = (e, t, n) => cx(t, n).map((t) => (uk(e, t), n)),
    gk = (e, t, n) => {
      const o = e.getBody(),
        r = ((e, t, n) => {
          ...
          .orThunk(() =>
            ((e, t, n, o, r) => {
              ...
              return Mu(e, n, s)
                ...
                .fold(
                  () => o.map(kx),
                  (r) => wx(t, n, r).map(T(Sx, e, t, n, s, r)).filter(T(Nx, o))
                )
                .filter(Cx);
            })(e, t, n, s, o)
          );
      })(n, T(Rh, e), o, r).bind((n) => fk(e, t, n));
    },
    pk = (e, t, n) => !!Nd(e) && gk(e, t, n).isSome(),
    hk = (e, t, n) =>
      !!Nd(t) &&
      ((e, t) => {
          ...
          Nd(e) &&
            (((e, t, n) => {
              const o = V(
                ...
                r = Y(o, e),
                s = Y(n, e);
              q(re(r, s), T(mk, !1)), q(re(s, r), T(mk, !0));
            })(n, e.dom, o.parents),
            ((e, t) => {
              const n = t.get();
    ...
    Ck = (e, t, n) => {
      if (Nd(e)) {
        const o = dk(e, t).getOrThunk(() => {
          const n = e.selection.getRng();
          return t ? Qi.fromRangeEnd(n) : Qi.fromRangeStart(n);
        });
        return wx(T(Rh, e), e.getBody(), o).exists((t) => {
          const o = kx(t);
          return cx(n, o).exists((t) => (uk(e, t), !0));
        });
      }
      return !1;
    },
    wk = (e, t) => (n) => cx(t, n).map((t) => () => uk(e, t)),
    Ek = (e, t, n, o) => {
      const r = e.getBody(),
        s = T(Rh, e);
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          Lh(e),
          wx(s, r, Qi.fromRangeStart(e.selection.getRng()))
            .map(_x)
            .bind(wk(e, t))
            .each(D);
      }),
      ...
      if (e.selection.isCollapsed() && Nd(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n
                ? e.fold(N(I.some(_x(e))), I.none, N(I.some(kx(e))), I.none)
                : e.fold(I.none, N(I.some(kx(e))), I.none, N(I.some(_x(e))))
            )
            .map(wk(e, t))
            .getOrThunk(() => {
              const i = Iu(n, r, o),
    ...
    Nk = (e) => {
      const t = ((e) => kk(e, (t) => e.schema.isBlock($t(t))))(e);
      return Sk(e, t);
    },
    Rk = (e, t) => {
      const n = Y(
        ((e) => kk(e, (t) => e.schema.isBlock($t(t)) || ((e) => jn(e) > 1)(t)))(
          e
        ),
        _k
      );
    ...
    Tk = (e) => dr(e.startContainer),
    Ok = (e) => {
      const t = e.selection.getRng();
      return (
        ((e) => 0 === e.startOffset && Tk(e))(t) &&
        ((e, t) => {
    ...
    Pk = (e) => (
      ((e) => {
        ...
        return (
          t.collapsed &&
          (Tk(t) || e.dom.isEmpty(t.startContainer)) &&
          !((e) => {
            return (
      ...
      e.selection.isCollapsed()
        ? ((e, t) => {
            ...
            return n(r)
              ...
              : I.from(Oh(t, r))
                  .filter((e) => n(e) && Cu(r, e))
                  .bind((n) => Dk(e, t, n.getNode(!t)));
          })(e, t)
        : ((e, t) => {
            const n = e.selection.getNode();
            return wr(n) ? Dk(e, t, n) : I.none();
          })(e, t),
    Mk = (e) => Ze(null != e ? e : "").getOr(0),
    Ik = (e, t) =>
    ...
    Hk = (e) => jk(e, "outdent"),
    $k = (e) => {
      if (e.selection.isCollapsed() && Fk(e)) {
        const t = e.dom,
          n = e.selection.getRng(),
          o = Qi.fromRangeStart(n),
          r = t.getParent(n.startContainer, t.isBlock);
        if (null !== r && qp(Cn(r), o, e.schema)) return I.some(() => Hk(e));
      }
      return I.none();
    },
    Vk = (e, t, n) =>
      ue([$k, YE, zE, (e, n) => xk(e, t, n), TE, gb, ex, Lk, PE, Bk, JE], (t) =>
        t(e, n)
    ...
    qk = (e) =>
      void 0 === e.touches || 1 !== e.touches.length
        ? I.none()
        : I.some(e.touches[0]),
    Wk = (e, t) => ke(e, t.nodeName),
    Kk = (e, t) =>
      !!dr(t) ||
      (!!er(t) && !(Wk(e.getBlockElements(), t) || rm(t) || Zr(e, t) || Ir(t))),
    Yk = (e, t) => {
      if (dr(t)) {
        if (0 === t.data.length) return !0;
        if (/^\s+$/.test(t.data))
          return !t.nextSibling || Wk(e, t.nextSibling) || Ir(t.nextSibling);
      }
      return !1;
    },
    Gk = (e) => e.dom.create(ql(e), Wl(e)),
    Xk = (e, t, n) => {
      const o = Cn(Gk(e)),
        r = Xa();
      yo(o, r), n(t, o);
    ...
    Zk = (e) => (t) => -1 !== (" " + t.attr("class") + " ").indexOf(e),
    Qk = (e, t, n) =>
      function (o) {
        const r = arguments,
          s = r[r.length - 2],
    ...
    t_ = (e, t) => {
      ...
      if (n)
        return "compositionstart" === t.type
          ...
          : void (ai(n) && (e_(e, n), e.undoManager.add()));
    },
    n_ = vr,
    o_ = (e, t, n) => {
    ...
    r_ = (e, t) =>
      ((e, t) => {
        const n = t ? wu.Forwards : wu.Backwards,
          o = e.selection.getRng();
        return ((e, t, n) => ik(t, e, n, Ip, Fp, n_))(n, e, o).orThunk(
          () => (o_(e, n, o), I.none())
        );
      })(
        e,
    ...
    s_ = (e, t) =>
      ...
      })(e, t).exists((t) => (sk(e, t), !0)),
    a_ = (e, t) => ck(e, t, t ? Fp : Ip),
    i_ = (e, t) =>
      jE(e, !t)
        .map((n) => {
          const o = n.toRange(),
    ...
    d_ = (e, t) =>
      ...
      ((e, t) => {
        ...
        return ((e, t, n) => {
          const o = T(_n, t);
          return Jn(Cn(e.container()), (e) => n.isBlock($t(e)), o).filter(l_);
        })(o, n, e.schema).exists(() => {
          if (((e, t, n) => (t ? $x(e.dom, n) : Hx(e.dom, n)))(n, t, o)) {
            const o = Xk(e, n, t ? yo : vo);
    ...
    h_ = (e, t) => {
      const n = t ? wu.Forwards : wu.Backwards,
        o = e.selection.getRng();
      return ik(e, n, o, Pp, Dp, wr).exists((t) => (sk(e, t), !0));
    },
    b_ = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return lk(e, n, o, Pp, Dp, wr).exists((t) => (sk(e, t), !0));
    },
    v_ = (e, t) => ck(e, t, t ? Dp : Pp),
    y_ = xl([
      { none: ["current"] },
      { first: ["current"] },
    ...
    w_ = (e, t, n) =>
      te(In(e), (e) => (xn(e, t) ? (n(e) ? [e] : []) : w_(e, t, n))),
    E_ = (e, t) => oo(e, "table", t),
    x_ = (e, t, n, o, r = M) => {
      const s = 1 === o;
      ...
      if (s && n >= e.length - 1) return C_.last(e[e.length - 1]);
      {
        const s = n + o,
          a = e[s];
        return r(a) ? C_.middle(t, a) : x_(e, t, s, o, r);
      }
    },
    k_ = (e, t) =>
      E_(e, t).bind((t) => {
    ...
    T_ = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === Tx.Wrap && 0 === e.positions.length)(o) ||
        (!pr(n.getNode()) &&
          ((e) => e.breakType === Tx.Br && 1 === e.positions.length)(o))
    ...
    L_ = (e, t, n, o) => {
      ...
      if (!t && O_(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            le(t.getClientRects())
              .bind((t) => R_(e, t.left, t.top))
              .bind((e) => {
                return Ix(
                  $u((n = e))
                    .map((e) => Fx(n, e).positions.concat(e))
                    .getOr([]),
                  t
                );
                var n;
          ...
          ((e, t) =>
            de(t.getClientRects())
              ...
              .bind((e) => {
                return Ix(
                  Hu((n = e))
                    .map((e) => [e].concat(Ux(n, e).positions))
                    .getOr([]),
                  t
                );
                var n;
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => Mx(jx(e, Qi.after(t)), n.left))
            )
    ...
    U_ = (e, t, n) =>
      n.fold(
        ...
        (n) => (e.execCommand("mceTableInsertRowAfter"), z_(e, t, n))
      ),
    z_ = (e, t, n) => {
      return U_(
        e,
    ...
    $_ = (e, t) => ({ container: e, offset: t }),
    V_ = ma.DOM,
    q_ = (e) => (t) => e === t ? -1 : 0,
    W_ = (e, t, n) => {
      if (dr(e) && t >= 0) return I.some($_(e, t));
      {
        const o = Ua(V_);
        return I.from(o.backwards(e, t, q_(e), n)).map((e) =>
          $_(e.container, e.container.data.length)
        );
      }
    },
    K_ = (e, t, n) => {
      ...
      const o = e.data;
      if (t >= 0 && t <= o.length) return I.some($_(e, t));
      {
        const o = Ua(V_);
        return I.from(o.backwards(e, t, q_(e), n)).bind((e) => {
          const o = e.container.data;
          return K_(e.container, t + o.length, n);
        });
      }
    },
    Y_ = (e, t, n) => {
      if (!dr(e)) return I.none();
      const o = e.data;
      if (t <= o.length) return I.some($_(e, t));
      {
        const r = Ua(V_);
        return I.from(r.forwards(e, t, q_(e), n)).bind((e) =>
          Y_(e.container, t - o.length, n)
        );
      }
    },
    G_ = (e, t, n, o, r) => {
    ...
    Q_ = (e, t, n, o = !1) => {
      ...
      return G_(
        ...
        return 0 !== r.lastIndexOf(n)
          ? I.none()
          : I.some({ text: Z_(r, n), range: o, trigger: n });
      });
    },
    J_ = (e) => {
      if (((e) => 3 === e.nodeType)(e)) return $_(e, e.data.length);
      {
        const t = e.childNodes;
        return t.length > 0 ? J_(t[t.length - 1]) : $_(e, t.length);
      }
    },
    eS = (e, t) => {
      const n = e.childNodes;
  ...
  const oS = (e, t, n) => (e.stype === nS.Error ? t(e.serror) : n(e.svalue)),
    rS = (e) => ({ stype: nS.Value, svalue: e }),
    sS = (e) => ({ stype: nS.Error, serror: e }),
    aS = oS,
    iS = (e) =>
      f(e) && fe(e).length > 100
        ? " removed due to size"
        : JSON.stringify(e, null, 2),
    lS = (e, t) => sS([{ path: e, getErrorInfo: t }]),
    dS = (e, t) => ({
      extract: (n, o) =>
        xe(o, e).fold(
          () =>
    ...
    uS = cS((e, t) => (g(e) && g(t) ? uS(e, t) : t)),
    mS = cS((e, t) => t),
    fS = (e) => ({ tag: "defaultedThunk", process: N(e) }),
    gS = (e) => {
      const t = ((e) => {
        const t = [],
          n = [];
    ...
    hS = (e) => ({
      extract: (t, n) => {
        return (
          (o = e(n)),
          (r = (e) => ((e, t) => lS(e, N(t)))(t, e)),
          o.stype === nS.Error ? r(o.serror) : o
        );
        var o, r;
      },
      toString: N("val"),
    ...
    bS = hS(rS),
    vS = (e, t, n, o) => o(xe(e, t).getOrThunk(() => n(e))),
    yS = (e, t, n, o, r) => {
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = I.some),
                s.stype === nS.Value
                  ? { stype: nS.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            }
    ...
    ES = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === nS.Error
              ? { stype: nS.Error, serror: t(e.serror) }
              : e)(t.extract([e], n), (e) => ({ input: n, errors: e })))(
          e,
          t,
          n
        )),
        oS(o, El.error, El.value)
      );
      var o;
    },
    xS = (e, t) => dS(e, he(t, CS)),
    ...
    _S = (e, t) =>
      hS((n) => {
        const o = typeof n;
        return e(n) ? rS(n) : sS(`Expected type: ${t} but got: ${o}`);
      }),
    SS = _S(E, "number"),
    NS = _S(m, "string"),
    RS = _S(b, "boolean"),
    ...
    BS = (e, t) => TS(e, e, { tag: "required", process: {} }, t),
    PS = (e) => BS(e, NS),
    DS = (e) => BS(e, AS),
    LS = (e, t) => TS(e, e, { tag: "option", process: {} }, t),
    MS = (e) => LS(e, NS),
    IS = (e, t, n) => TS(e, e, fS(t), n),
    FS = (e, t) => IS(e, t, SS),
    US = (e, t, n) =>
      IS(
        e,
    ...
    ZS = zS("enabled", !0),
    QS = zS("primary", !1),
    JS = (e) => ((e, t) => IS("type", t, NS))(0, e),
    eN = CS([
      HS,
      PS("trigger"),
      FS("minChars", 1),
      (1, ((e, t) => TS(e, e, fS(1), kS()))("columns")),
      FS("maxResults", 10),
      ("matches", LS("matches", AS)),
      $S,
      VS,
      ((tN = NS), IS("highlightOn", [], wS(tN))),
    ]);
  var tN;
  const nN = [ZS, YS, KS, WS, qS],
    oN = [XS].concat(nN),
    rN = [
      jS("predicate", L),
    ...
    sN = nN.concat([JS("contextformbutton"), QS, VS, OS("original", R)]),
    aN = oN.concat([JS("contextformbutton"), QS, VS, OS("original", R)]),
    iN = nN.concat([JS("contextformbutton")]),
    lN = oN.concat([JS("contextformtogglebutton")]),
    dN = xS("type", { contextformbutton: sN, contextformtogglebutton: aN });
  CS(
    [
      JS("contextform"),
      jS("initValue", N("")),
      GS,
      ((e, t) => TS(e, e, { tag: "required", process: {} }, wS(t)))(
        "commands",
        dN
      ),
      LS(
        "launch",
        xS("type", { contextformbutton: iN, contextformtogglebutton: lN })
      ),
    ].concat(rN)
  );
  const cN = (e) => {
      const t = e.ui.registry.getAll().popups,
        n = he(t, (e) => {
          return ((t = e), ES("Autocompleter", eN, t)).fold((e) => {
            throw new Error(
              "Errors: \n" +
                ((e) => {
                  const t =
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                Q_(e.dom, e.selection.getRng(), t.trigger, !0).bind((t) =>
                  tS(e, s, t, n)
                )
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ue(n.triggers, (n) => Q_(e, t, n)))(
                    e.dom,
                    o,
                    n
                  ).bind((n) => tS(e, t, n));
    ...
    pN = (e, t) => I.from(e.getParent(t.container(), "details")),
    hN = (e, t) => pN(e, t).isSome(),
    bN = (e, t) => {
      const n = t.getNode();
      ...
      if ("character" === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            Iu(!t, s, n).exists((e) => hN(o, e) && !Mt(i, pN(o, e)))
          ) ||
          Iu(t, s, n).fold(L, (n) => {
            const r = pN(o, n);
            if (hN(o, n) && !Mt(i, r)) {
    ...
    _N = xt(),
    SN = _N.os,
    NN = SN.isMacOS() || SN.isiOS(),
    RN = _N.browser.isFirefox(),
    AN = (e, t) => {
      const n = e.dom,
    ...
    DN = (e, t, n, o, r = !0, s, a) => {
      ...
      return PN(e, f), BN(g), f;
    },
    LN = (e, t) => {
      const n = null == e ? void 0 : e.parentNode;
      return C(n) && n.nodeName === t;
    },
    MN = (e) => C(e) && /^(OL|UL|LI)$/.test(e.nodeName),
    IN = (e) => C(e) && /^(LI|DT|DD)$/.test(e.nodeName),
    FN = (e) => {
      const t = e.parentNode;
      return IN(t) ? t : e;
    },
    ...
    jN = (e, t) => t && "A" === t.nodeName && e.isEmpty(t),
    HN = (e, t) =>
      e.nodeName === t ||
      ...
      insert: (e, t) => {
        ...
        if (/^(LI|DT|DD)$/.test(r) && er(s) && i.isEmpty(_))
          return void ((e, t, n, o, r) => {
            ...
            var l;
            MN((l = n)) && MN(l.parentNode) && (r = "LI");
            const d = IN(o) ? zN(o) : void 0;
            let c = IN(o) && d ? t(r, { style: zN(o) }) : t(r);
            if (UN(n, o, !0) && UN(n, o, !1))
              if (LN(n, "LI")) {
                const e = FN(n);
                s.insertAfter(c, e),
                  ((e) => {
              ...
              LN(n, "LI")
                ? (s.insertAfter(c, FN(n)),
                  c.appendChild(s.doc.createTextNode(" ")),
                  c.appendChild(n))
                : i.insertBefore(c, n),
                s.remove(o);
            else if (UN(n, o, !1)) s.insertAfter(c, FN(n)), s.remove(o);
            else {
              n = FN(n);
        ...
        if (p)
        ...
        else if (oi(_)) (R = ui(_)), i.isEmpty(_) && BN(_), PN(e, R), AN(e, R);
        else if (v(!1)) R = w();
        else if (v(!0) && N) {
          ...
          const t = ((e) => {
            ...
            return (
              t.setStart(
                e.startContainer,
                VN(!0, e.startContainer, e.startOffset)
              ),
              t.setEnd(e.endContainer, VN(!1, e.endContainer, e.endOffset)),
              t
            );
          })(d).cloneRange();
          t.setEndAfter(_);
          ...
          ((e) => {
            ...
            i.isEmpty(_) && BN(_),
            R.normalize(),
            i.isEmpty(R) ? (i.remove(R), w()) : (PN(e, R), AN(e, R));
        }
    ...
    YN = (e, t) => {
      GN(e.getBody(), t) || bo(Cn(t), vn("br"));
      const n = vn("br");
      bo(Cn(t), n), WN(e, n.dom, !1), e.undoManager.add();
    },
    GN = (e, t) => {
      return (
        (n = Qi.after(t)),
    ...
    XN = (e) => e && "A" === e.nodeName && "href" in e,
    ZN = (e) => e.fold(L, XN, XN, L),
    QN = (e, t) => {
      t.fold(k, T(KN, e), T(YN, e), k);
    },
    JN = {
      insert: (e, t) => {
        const n = ((e) => {
          ...
          return wx(t, e.getBody(), n).filter(ZN);
        })(e);
        n.isSome()
          ? n.each(T(QN, e))
          : ((e, t) => {
    ...
    rR = (e, t) => (n, o) => {
      const r =
        ((e) => ON(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    sR = (e) => {
    ...
    fR = (e, t, n) => {
      t.selection.isCollapsed() ||
        ...
        (C(n) && kN(t, e.fakeEventName).isDefaultPrevented()) ||
          (e.insert(t, n), C(n) && xN(t, e.fakeEventName));
    },
    gR = (e, t) => {
      const n = () => fR(JN, e, t),
        o = () => fR(qN, e, t),
        r = ((e, t) =>
          ux(
            [
              mR([nR], tR.none()),
              mR([aR(!0), sR], tR.none()),
              mR([rR("summary", !0)], tR.br()),
              mR([aR(!0), iR(!1), dR], tR.br()),
              mR([aR(!0), iR(!1)], tR.block()),
              mR([aR(!0), iR(!0), dR], tR.block()),
              mR([aR(!0), iR(!0)], tR.br()),
              mR([oR(!0), dR], tR.br()),
              mR([oR(!0)], tR.block()),
              mR([lR], tR.br()),
    ...
    pR = xt(),
    hR = pR.os.isiOS() && pR.browser.isSafari(),
    bR = (e, t) => {
      var n;
    ...
    vR = xt(),
    yR = (e) => e.stopImmediatePropagation(),
    CR = (e) => e.keyCode === yf.PAGE_UP || e.keyCode === yf.PAGE_DOWN,
    wR = (e, t, n) => {
      n && !e.get()
        ? t.on("NodeChange", yR, !0)
        : !n && e.get() && t.off("NodeChange", yR),
        e.set(n);
    },
    ER = (e, t) => {
      const n = t.container(),
    ...
    RR = (e) =>
      kc(e)
        ? [
            { keyCode: yf.TAB, action: f_(H_, e, !0) },
            { keyCode: yf.TAB, shiftKey: !0, action: f_(H_, e, !1) },
          ]
        : [],
    AR = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), uN(e), sw(e)))
        return Br(null);
      {
        const t = bk(e);
        return (
            ...
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  g_(
                    [
                      { keyCode: yf.RIGHT, action: f_(r_, e, !0) },
                      { keyCode: yf.LEFT, action: f_(r_, e, !1) },
                      { keyCode: yf.UP, action: f_(s_, e, !1) },
                      { keyCode: yf.DOWN, action: f_(s_, e, !0) },
                      ...(o
                        ? [
                            {
                              keyCode: yf.UP,
                        ...
                        : []),
                      { keyCode: yf.RIGHT, action: f_(I_, e, !0) },
                      { keyCode: yf.LEFT, action: f_(I_, e, !1) },
                      { keyCode: yf.UP, action: f_(F_, e, !1) },
                      { keyCode: yf.DOWN, action: f_(F_, e, !0) },
                      { keyCode: yf.UP, action: f_(F_, e, !1) },
                      { keyCode: yf.UP, action: f_(c_, e, !1) },
                      { keyCode: yf.DOWN, action: f_(c_, e, !0) },
                      { keyCode: yf.RIGHT, action: f_(h_, e, !0) },
                      { keyCode: yf.LEFT, action: f_(h_, e, !1) },
                      { keyCode: yf.UP, action: f_(b_, e, !1) },
                      { keyCode: yf.DOWN, action: f_(b_, e, !0) },
                      { keyCode: yf.RIGHT, action: f_(pk, e, t, !0) },
                      { keyCode: yf.LEFT, action: f_(pk, e, t, !1) },
                      {
                        keyCode: yf.RIGHT,
                        ctrlKey: !o,
                        altKey: o,
                      ...
                      { keyCode: yf.UP, action: f_(d_, e, !1) },
                      { keyCode: yf.DOWN, action: f_(d_, e, !0) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              (n = o.keyCode === yf.BACKSPACE),
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    p_(
                      [
                        { keyCode: yf.BACKSPACE, action: f_($k, e) },
                        { keyCode: yf.BACKSPACE, action: f_(YE, e, !1) },
                        { keyCode: yf.DELETE, action: f_(YE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(zE, e, !1) },
                        { keyCode: yf.DELETE, action: f_(zE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(xk, e, t, !1) },
                        { keyCode: yf.DELETE, action: f_(xk, e, t, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(gb, e, !1) },
                        { keyCode: yf.DELETE, action: f_(gb, e, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(wN, e, !1, s) },
                        { keyCode: yf.DELETE, action: f_(wN, e, !0, s) },
                        ...(NN
                          ? [
                              {
                                keyCode: yf.BACKSPACE,
                                altKey: !0,
                                action: f_(wN, e, !1, a(!0)),
                              },
                              {
                                keyCode: yf.DELETE,
                                altKey: !0,
                                action: f_(wN, e, !0, a(!0)),
                              },
                              {
                                keyCode: yf.BACKSPACE,
                                metaKey: !0,
                                action: f_(wN, e, !1, a(!1)),
                              },
                            ]
                          : [
                              {
                        ...
                        { keyCode: yf.BACKSPACE, action: f_(ex, e, !1) },
                        { keyCode: yf.DELETE, action: f_(ex, e, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(Lk, e, !1) },
                        { keyCode: yf.DELETE, action: f_(Lk, e, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(PE, e, !1) },
                        { keyCode: yf.DELETE, action: f_(PE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(TE, e, !1) },
                        { keyCode: yf.DELETE, action: f_(TE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(Bk, e, !1) },
                        { keyCode: yf.DELETE, action: f_(Bk, e, !0) },
                        { keyCode: yf.BACKSPACE, action: f_(JE, e, !1) },
                        { keyCode: yf.DELETE, action: f_(JE, e, !0) },
                      ],
                      n
                    )
                      .filter((t) => e.selection.isEditable())
                      .each((t) => {
                        n.preventDefault(),
                          kN(e, o).isDefaultPrevented() || (t(), xN(e, o));
                      });
                  })(e, t, o);
            }),
              e.on("keyup", (t) => {
                t.isDefaultPrevented() ||
                  ((e, t, n) => {
                    g_(
                      [
                        { keyCode: yf.BACKSPACE, action: f_(KE, e) },
                        { keyCode: yf.DELETE, action: f_(KE, e) },
                        ...(NN
                          ? [
                              {
                                keyCode: yf.BACKSPACE,
            ...
            e.on("keydown", (t) => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  p_(
                    [
                      { keyCode: yf.SPACEBAR, action: f_(SR, e) },
                      { keyCode: yf.SPACEBAR, action: f_(NR, e) },
                    ],
                    t
                  ).each((n) => {
                    t.preventDefault(),
                      kN(e, "insertText", { data: " " }).isDefaultPrevented() ||
                        (n(), xN(e, "insertText", { data: " " }));
                  });
                })(e, t);
            });
          })(e),
            ...
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  g_(
                    [
                      { keyCode: yf.END, action: f_(a_, e, !0) },
                      { keyCode: yf.HOME, action: f_(a_, e, !1) },
                      ...(o
                        ? []
                        : [
                            {
                      ...
                      { keyCode: yf.END, action: f_(v_, e, !0) },
                      { keyCode: yf.HOME, action: f_(v_, e, !1) },
                      { keyCode: yf.END, action: f_(Ck, e, !0, t) },
                      { keyCode: yf.HOME, action: f_(Ck, e, !1, t) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              e.on("keyup", (o) => {
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    g_(
                      [
                        { keyCode: yf.PAGE_UP, action: f_(Ck, e, !1, t) },
                        { keyCode: yf.PAGE_DOWN, action: f_(Ck, e, !0, t) },
                      ],
                      n
                    );
                  })(e, t, o),
                  CR(o) && n.get() && (wR(n, e, !1), e.nodeChanged());
              });
          })(e, t),
          t
        );
  ...
  const OR = Da("image"),
    ...
    IR =
      ...
      (e) => {
        const t = e;
        return I.from(t[BR]).exists((e) => 0 === e);
      });
  const FR = Da("mode"),
    UR = (e) => (t) => {
      t[FR] = e;
    ...
    VR = (e) => (t) => {
      const n = t;
      return I.from(n[FR]).exists((t) => t === e);
    },
    qR = VR(0),
    WR = VR(1),
    ...
    lA = (e, t) => ({ content: e, cancelled: t }),
    dA = (e, t) => (e.insertContent(t, { merge: dc(e), paste: !0 }), !0),
    cA = (e) => /^https?:\/\/[\w\-\/+=.,!;:&%@^~(){}?#]+$/i.test(e),
    uA = (e, t, n) =>
      !(e.selection.isCollapsed() || !cA(t)) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    mA = (e, t, n) =>
      !!((e, t) =>
        cA(t) && $(xc(e), (e) => Ve(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
        ...
        ((e, t, n) => {
          ...
          return e.hasEventListeners("PastePostProcess") &&
            ...
            ? ((e, t, n) => {
                ...
                return lA(r.node.innerHTML, r.isDefaultPrevented());
              })(e, r, n)
            : lA(r, o.isDefaultPrevented());
        })(e, t, n))(e, t, n);
      if (!s.cancelled) {
        const t = s.content,
          n = () =>
            ((e, t, n) => {
              n || !cc(e)
                ? dA(e, t)
                : ((e, t) => {
                    Dt.each([uA, mA, dA], (n) => !n(e, t, dA));
                  })(e, t);
            })(e, t, o);
        r
          ? kN(e, "insertFromPaste", {
              dataTransfer: gA(t),
            }).isDefaultPrevented() || (n(), xN(e, "insertFromPaste"))
          : n();
      }
    },
    hA = (e, t, n, o) => {
      const r = n || tA(t);
      pA(e, ((e) => e.replace(JR, ""))(t), r, !1, o);
    },
    bA = (e, t, n) => {
    ...
    yA = (e, t) => t in e && e[t].length > 0,
    CA = (e) => yA(e, "text/html") || yA(e, "text/plain"),
    wA = (e, t, n) => {
          ...
          (s =
            yA(t, "text/plain") && i
              ...
              : ((e) => {
                  ...
                  return (e = aA(e, [/<!\[[^\]]+\]>/g])), i(n.parse(e)), o;
                })(s)),
        sA(s) || (o ? bA(e, s, r) : hA(e, s, a, r));
    },
    xA = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on("keydown", (e) => {
          ...
          e.on("paste", (r) => {
            ...
            o = !1;
            const a = vA(r.clipboardData);
            (!CA(a) && wA(e, r, t.getLastRng() || e.selection.getRng())) ||
              (yA(a, "text/html")
                ? (r.preventDefault(), EA(e, a, a["text/html"], s, !0))
                : yA(a, "text/plain") && yA(a, "text/uri-list")
                ? (r.preventDefault(), EA(e, a, a["text/plain"], s, !0))
                : (t.create(),
                  Tg.setEditorTimeout(
                    e,
                    () => {
                      const n = t.getHtml();
                      t.remove(), EA(e, a, n, s, !1);
                    },
                    0
                  )));
          });
    ...
    TA = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi,
    OA = (e) => Dt.trim(e).replace(TA, Ws).toLowerCase(),
    BA = (e, t, n) => {
      const o = ic(e);
            ...
            remove: () =>
              ((e, t) => {
                ...
                if (oA(e)) {
                  let o;
                  const r = t.get();
                  for (; (o = oA(e)); ) n.remove(o), n.unbind(o);
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              n.html && hA(e, n.html, n.internal, !1),
                n.text && bA(e, n.text, !1);
            });
        })(e, n),
        ((e) => {
          const t = (t) => (n) => {
          ...
          ((e) => {
            e.on(
              ...
              e.on(
                "copy",
                ((e) => (t) => {
                  !t.isDefaultPrevented() && NA(e) && kA(t, SA(e), _A(e), k);
                })(e)
              );
          })(e),
            ((e, t) => {
              nc(e) &&
                ...
                e.on("drop", (n) => {
                  ...
                  (d && !l) ||
                    (i &&
                      ...
                      Tg.setEditorTimeout(e, () => {
                        e.undoManager.transact(() => {
                          (a || (d && l)) && e.execCommand("Delete"), AA(e, o);
                          const t = iA(i);
                          r["text/html"] ? hA(e, t, s, !0) : bA(e, t, !0);
                        });
                      })));
                }),
                e.on("dragstart", (e) => {
                ...
                e.on("dragover dragend", (n) => {
                  oc(e) && !t.get() && (n.preventDefault(), AA(e, RA(e, n))),
    ...
    MA = (e) => vr(e.dom),
    IA = (e) => (t) => _n(Cn(e), t),
    FA = (e, t) => Jn(Cn(e), MA, IA(t)),
    UA = (e, t, n) => {
      const o = new Vo(e, t),
        r = n ? o.next.bind(o) : o.prev.bind(o);
      let s = e;
      for (let t = n ? e : r(); t && !DA(t); t = r()) Bi(t) && (s = t);
      return s;
    },
    zA = (e) => {
      const t = ((e, t, n) => {
        ...
        return (
          FA(s, r).fold(
            () => {
              LA(s) ? i.setStart(s, 0) : i.setStartBefore(s);
            },
            (e) => i.setStartBefore(e.dom)
          ),
          FA(a, r).fold(
            () => {
              LA(a) ? i.setEnd(a, a.data.length) : i.setEndAfter(a);
            },
  ...
  const HA = (e, t) => Math.abs(e.left - t),
    $A = (e, t) => Math.abs(e.right - t),
    VA = (e, t) =>
      ((e) =>
        X(
          e,
    ...
    KA = (e, t, n) =>
      ((e, t, n) => {
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: HA(e, t) < $A(e, t) ? jA.Before : jA.After,
          }))(e, t)
        ),
    YA = (e) => {
      var t, n;
    ...
    XA = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...GA(n) }))(
            e,
            o,
            t,
            r
    ...
    aT = (e, t, n, o, r) => {
      "dragstart" === t && XR(o, e.dom.getOuterHTML(n));
      const s = XA(t, n, o, r);
    ...
    iT = (e, t) => {
      ...
      return (r) =>
        e.on((e) => {
          ...
          if (!e.dragging && s > 10) {
            const n = aT(t, "dragstart", e.element, e.dataTransfer, r);
            if (
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? YA(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
                    ...
                    (r = ((e, t) => {
                      if (t.target.ownerDocument !== e.getDoc()) {
                        const n = YA(e.getContentAreaContainer()),
                          o = ((e) => {
                            const t = e.getBody(),
    ...
    lT = (e, t, n) => {
      e.on((e) => {
        e.intervalId.clear(),
          e.dragging &&
            n.fold(
              () => aT(t, "dragend", e.element, e.dataTransfer),
              (n) => aT(t, "dragend", e.element, e.dataTransfer, n)
            );
      }),
        dT(e);
    },
    ...
    cT = (e) => {
      const t = Dr(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            ...
            if (
              C(o) &&
              ((e, t, n) => ZA(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o
              )
              ...
              e.set({
                ...
                ghost: JA(t, o, o.offsetWidth, o.offsetHeight),
                intervalId: Pr(100),
              });
            }
          }
        ...
        a = ((e, t) => (n) => {
          e.on((e) => {
            ...
            if ((e.intervalId.clear(), e.dragging)) {
              if (
                ...
                const r =
                  ...
                  void 0 !== o
                    ? o
                    : t.getBody();
                aT(t, "drop", r, e.dataTransfer, n).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    ((e, t) => {
              ...
              aT(t, "dragend", t.getBody(), e.dataTransfer, n);
            }
          }),
            dT(e);
        })(t, e),
      ...
      e.on("mousedown", r),
        ...
        e.on("keydown", (n) => {
          n.keyCode === yf.ESC && lT(t, e, I.none());
        });
    },
    uT = vr,
    mT = (e, t) => pb(e.getBody(), t),
    fT = (e) => {
      const t = e.selection,
        n = e.dom,
        o = e.getBody(),
      ...
      return (
        sw(e) ||
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = mT(e, n);
              uT(o)
                ? (t.preventDefault(), LE(e, o).each(f))
                : l(n) && LE(e, n).each(f);
            },
            !0
          ),
          e.on("mousedown", (r) => {
            ...
            const a = mT(e, s);
            uT(a)
              ? (r.preventDefault(), LE(e, a).each(f))
              : KA(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === jA.Before, !1)) &&
                      t.setRng(o),
                    tr(a) ? a.focus() : e.getBody().focus();
                });
          }),
          e.on("keypress", (e) => {
            yf.modifierPressed(e) || (uT(t.getNode()) && e.preventDefault());
          }),
              ...
              e.on("focusin", (t) => {
                ...
                if (wr(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    LE(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    vT = (e, t) =>
      bT(e, t.start).bind(({ node: n, offset: o }) =>
        bT(e, t.end).map(({ node: e, offset: t }) => {
          const r = document.createRange();
    ...
    yT = (e, t, n) => {
      if (t && e.isEmpty(t) && !n(t)) {
        const o = t.parentNode;
        e.remove(t, dr(t.firstChild) && Go(t.firstChild.data)), yT(e, o, n);
      }
    },
    CT = (e, t, n, o = !0) => {
    ...
    wT = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
    ET = (e, t, n) => {
    ...
    kT = (e, t) => e.create("span", { "data-mce-type": "bookmark", id: t }),
    _T = (e, t) => {
      const n = e.createRng();
      return n.setStartAfter(t.start), n.setEndBefore(t.end), n;
    },
    ST = (e, t, n) => {
      const o = vT(e.getRoot(), n).getOrDie("Unable to resolve path range"),
        r = o.startContainer,
        s = o.endContainer,
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(kT(e, t + "-end"), a),
        start: l.insertBefore(kT(e, t + "-start"), i),
      };
    },
    NT = (e, t, n) => {
      yT(e, e.get(t.prefix + "-end"), n), yT(e, e.get(t.prefix + "-start"), n);
    },
    RT = (e) => 0 === e.start.length,
    AT = (e, t, n, o) => {
      const r = t.start;
      var s;
      return G_(
        ...
        }
        {
          ...
          return K_(o.container, s, n)
            ...
            .orThunk(() => AT(e, t, n, $_(o.container, 0)));
        }
      });
    },
    TT = (e, t, n, o) => {
      const r = e.dom,
        ...
        l = n.position.offset;
      return K_(i, l - n.pattern.end.length, t).bind((d) => {
        const c = hT(r, s, d.container, d.offset, i, l, o);
        if (RT(a))
          return I.some({
        ...
        {
          const i = OT(e, n.remainingPatterns, d.container, d.offset, t, o),
          ...
          return m.map((e) => {
            ...
            return {
              ...
              position: $_(e.startContainer, e.startOffset),
            };
          });
        }
      });
    ...
    OT = (e, t, n, o, r, s) => {
      const a = e.dom;
      return W_(n, o, a.getRoot()).bind((i) => {
        const l = xT(a, r, n, o);
        for (let a = 0; a < t.length; a++) {
          const d = t[a];
          ...
          if (u.isNone() && o > 0) return OT(e, t, n, o - 1, r, s);
    ...
    PT = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        OT(e, r.inlinePatterns, n, o, t, s).fold(
          () => [],
          (e) => e.matches
        ),
        OT(
    ...
    DT = (e, t) => {
        ...
        r = ((e, t) => {
          const n = Da("mce_textpattern"),
            o = G(
              t,
              (t, o) => {
                const r = ST(e, n + `_end${t.length}`, o.endRng);
      ...
      q(r, (t) => {
        ...
        RT(t.pattern)
          ...
          NT(n, t.endMarker, r),
          NT(n, t.startMarker, r);
      }),
        e.selection.moveToBookmark(o);
    },
    LT = (e, t, n) =>
      ((e, t, n) => {
        if (dr(e) && 0 >= e.length) return I.some($_(e, 0));
        {
          const t = Ua(V_);
          return I.from(t.forwards(e, 0, q_(e), n)).map((e) =>
            $_(e.container, 0)
          );
        }
      })(t, 0, t).map((o) => {
    ...
    MT = (e) => (t, n) => {
      const o = t.dom,
        r = n.pattern,
        s = vT(o.getRoot(), n.range).getOrDie("Unable to resolve path range");
      return (
        wT(t, s).each((n) => {
          "block-format" === r.type
            ? ((e, t) => {
        ...
        ? e(r.blockPatterns, a)
            .map((e) =>
              t && Dt.trim(a).length === e.start.length
                ? []
                : [{ pattern: e, range: hT(l, l.getRoot(), o, 0, o, 0, s) }]
            )
            .getOr([])
        : [];
    },
    ...
    zT = IT((e, t, n) => 0 === t.indexOf(e.start) || 0 === n.indexOf(e.start)),
    jT = FT(zT, !0),
    HT = MT(LT),
    $T = IT((e, t, n) => t === e.start || n === e.start),
    VT = FT($T, !1),
    qT = (e, t, n) => {
    ...
    WT = (e) => {
                ...
                ((e, t) => {
                  ...
                  return wT(e, n)
                    .map((o) => {
                      ...
                      return {
                        inlineMatches: PT(e, o, n.startContainer, s, a, !0),
                        blockMatches: jT(e, o, a, !0),
                      };
                    })
                    .filter(
                    ...
                    return wT(e, n)
                      .map((o) => {
                        const r = Math.max(0, n.startOffset),
                          s = xT(e.dom, o, n.startContainer, r),
                          a = ET(t, o, s);
                        return VT(e, o, a, !1, s);
                      })
                      .filter((e) => e.length > 0);
            ...
            ((e, t) => {
              ...
              wT(e, n).map((o) => {
                const r = Math.max(0, n.startOffset - 1),
                  s = xT(e.dom, o, n.startContainer, r),
                  a = ET(t, o, s),
                  i = PT(e, o, n.startContainer, r, a, !1);
                i.length > 0 &&
                  e.undoManager.transact(() => {
                    DT(e, i);
                  });
      ...
      e.on("keyup", (e) => {
        qT(n, e, (e, t) => e === t.keyCode && !yf.modifierPressed(t)) && s();
      }),
        e.on("keypress", (n) => {
          qT(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
    ...
    YT = ma.DOM,
    GT = (e) => (e.inline ? e.getElement().nodeName.toLowerCase() : void 0),
    XT = (e) => Ce(e, (e) => !1 === v(e)),
    ZT = (e) => {
    ...
    JT = (e) => (e.inline ? e.ui.styleSheetLoader : e.dom.styleSheetLoader),
    eO = (e) => {
      const t = JT(e),
        n = pd(e),
        o = e.contentCSS,
          ...
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
              ...
              s = o.map((t) => {
                ...
                return m(n)
                  ? Promise.resolve(JT(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, JT(e).loadAll(r)];
    ...
    nO = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (YT.addClass(t, "mce-content-body"),
      ...
      (o.disabled = !0),
        ...
        !e.readonly &&
          e.hasEditableRoot() &&
          (e.inline &&
            "static" === YT.getStyle(o, "position", !0) &&
        ...
        (e.formatter = fE(e)),
        (e.undoManager = pE(e)),
        (e._nodeChangeDispatcher = new TR(e)),
        (e._selectionOverrides = fT(e)),
        ((e) => {
          const t = Dr(),
            n = Br(!1),
            o = wa((t) => {
            ...
            e.on("BeforeSetContent", (t) => {
              ((e, t, n) => {
                let o = t.length,
                  r = n.content;
                if ("raw" !== n.format) {
                  for (; o--; ) r = r.replace(t[o], Qk(e, r, hc(e)));
                  n.content = r;
                }
              })(e, a, t);
            }),
        ...
        sw(e) ||
          (((e) => {
            e.on("mousedown", (t) => {
              t.detail >= 3 && (t.preventDefault(), zA(e));
            });
          })(e),
          ((e) => {
            WT(e);
          ...
          e.on("NodeChange", () =>
            ((e) => {
              ...
              if (
                ...
                ((e, t, n) => $(Up(Cn(n), Cn(t)), (t) => Wk(e, t.dom)))(r, a, s)
              )
                return;
              ...
              for (; m; )
                if ((er(m) && Kr(o, m), Kk(o, m))) {
                  ...
                  if (!i) {
                    ...
                    (i = Gk(e)), a.insertBefore(i, m);
                  }
                  (l = m), (m = m.nextSibling), i.appendChild(l);
                } else (i = null), (m = m.nextSibling);
              d && (e.selection.setRng(QE(d)), e.nodeChanged());
            })(e)
          );
        })(e),
        ((e) => {
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          ec(e) ||
            ((t.body.spellcheck = !1), YT.setAttrib(n, "spellcheck", "false")),
          (e.quirks = KT(e)),
          ((e) => {
          ...
          (t) => {
            e.setProgressState(!0),
              eO(e).then(() => {
                t().then(
                  (t) => {
                    e.setProgressState(!1), tO(e), lw(e);
                  },
                  (t) => {
                    e.notificationManager.open({
                      type: "error",
    ...
    rO = ma.DOM,
    sO = ma.DOM,
    aO = (e, t) => ({ editorContainer: e, iframeContainer: t, api: {} }),
    iO = (e) => {
      const t = e.getElement();
      return e.inline
        ? aO(null)
        : ((e) => {
            ...
            return sO.insertAfter(t, e), aO(t, t);
          })(t);
    },
    lO = async (e) => {
              ...
              ((e, t) => {
                ...
                ((e) => {
                  const t = e.iframeElement,
                    n = () => {
                      (e.contentDocument = t.contentDocument), nO(e);
                    };
    ...
    wO = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: yO(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = bO(["mobile"], uS(a, r)),
        l = Dt.extend(
          n,
          ...
          ((e, t) => e && vO(t, "mobile"))(e, i)
            ...
            : {},
          { external_plugins: CO(o, i.options()) }
        );
      return ((e, t, n, o) => {
        const r = hO(n.forced_plugins),
          s = hO(o.plugins),
          a = ((e, t) => (vO(e, t) ? e.sections()[t] : {}))(t, "mobile"),
          i = ((e, t, n, o) => (e && vO(t, "mobile") ? o : n))(
            e,
            t,
            s,
            a.plugins ? hO(a.plugins) : s
          ),
          l = ((e, t) => [...hO(e), ...hO(t)])(r, i);
    ...
    _O = { "font-size": "size", "font-family": "face" },
    SO = Zt("font"),
    NO = (e) => (t, n) =>
      I.from(n)
        .map(Cn)
          ...
          ((e, t, n) =>
            Hb(
              ...
              (t) =>
                ((t) =>
                  fo(t, e).orThunk(() =>
                    SO(t) ? xe(_O, e).bind((e) => nn(t, e)) : I.none()
                  ))(t),
              (e) => _n(Cn(t), e)
            ))(e, t, n.dom).or(
      ...
      EO(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            insertImage: (t, n, o) => {
              kO(e, e.dom.createHTML("img", { src: o }));
            },
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            e.editorCommands.addCommands({ Outdent: () => Fk(e) }, "state");
        })(e),
        ((e) => {
          e.editorCommands.addCommands({
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = BO(e, t);
                  e.formatter.toggle("fontname", { value: PO(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: BO(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => OO(e, (t) => AO(e.getBody(), t.dom)).getOr(""))(e)
                ),
                e.editorCommands.addQueryValueHandler("FontSize", () =>
                  ((e) => OO(e, (t) => RO(e.getBody(), t.dom)).getOr(""))(e)
                ),
  ...
  class FO {
    ...
    queryCommandState(e) {
      if ((!IO(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
  ...
  const UO = "data-mce-contenteditable",
    zO = (e, t, n) => {
      try {
        e.getDoc().execCommand(t, !1, String(n));
      } catch (e) {}
    ...
    $O = (e) => {
      e.parser.addAttributeFilter("contenteditable", (t) => {
        HO(e) &&
          q(t, (e) => {
            e.attr(UO, e.attr("contenteditable")),
              e.attr("contenteditable", "false");
          });
      }),
        e.serializer.addAttributeFilter(UO, (t) => {
          HO(e) &&
            q(t, (e) => {
              e.attr("contenteditable", e.attr(UO));
            });
        }),
        e.serializer.addTempAttr(UO);
    },
    VO = ["copy"],
    qO = Dt.makeMap(
  ...
  const KO = (e) => (
      e._eventDispatcher ||
        (e._eventDispatcher = new WO({
          scope: e,
          toggleEvent: (t, n) => {
            WO.isNative(t) && e.toggleNativeEvent && e.toggleNativeEvent(t, n);
          },
        })),
      e._eventDispatcher
    ),
  ...
  const ZO = (e, t) => {
      ...
      const n = wd(e);
      return n
        ? (e.eventRoot || (e.eventRoot = GO.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    QO = (e, t, n) => {
      ((e) => !e.hidden && !HO(e))(e)
        ...
        : HO(e) &&
          ((e, t) => {
            ...
            } else ((e) => H(VO, e.type))(t) && e.dispatch(t.type, t);
          })(e, n);
    },
    JO = (e, t) => {
      ...
      if (wd(e)) {
        ...
        const o = (n) => {
          ...
          for (; s--; ) {
            const e = r[s].getBody();
            (e === o || GO.isChildOf(o, e)) && QO(r[s], t, n);
          }
        };
        (XO[t] = o), GO.bind(n, t, o);
      } else {
        const o = (n) => {
          QO(e, t, n);
        };
        GO.bind(n, t, o), (e.delegates[t] = o);
      }
    },
    eB = {
      ...YO,
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(ZO(n, e), e, n.delegates[e]),
    ...
    nB = (e, t) => e + (Xe(t.message) ? "" : `. ${t.message}`),
    oB = (e) => e.valid,
    rB = (e, t, n = "") => {
      const o = t(e);
      return b(o)
          ...
          ((e, t) => {
            ...
            ((e, t, n) => {
              ...
              t
                ...
                : ((e.readonly = !1),
                  e.hasEditableRoot() && jO(n, !0),
                  q(zo(n, `*[${UO}="true"]`), (e) => {
                    rn(e, UO), jO(e, !0);
                  }),
                  zO(e, "StyleWithCSS", !1),
                  zO(e, "enableInlineTableEditing", !1),
                  zO(e, "enableObjectResizing", !1),
                  jg(e) && e.focus(),
                  ((e) => {
                    e.selection.setRng(e.selection.getRng());
                  })(e),
    ...
    cB = Dt.makeMap("alt,ctrl,shift,meta,access"),
    uB = (e) => {
      const t = {},
        n = Tt.os.isMacOS() || Tt.os.isiOS();
      iB(lB(e.toLowerCase(), "+"), (e) => {
        ((e) => e in cB)(e)
          ? (t[e] = !0)
          : /^[0-9]{2,}$/.test(e)
          ? (t.keyCode = parseInt(e, 10))
          : ((t.charCode = e.charCodeAt(0)),
            (t.keyCode = dB[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
      for (r in cB) t[r] ? o.push(r) : (t[r] = !1);
      return (
        (t.id = o.join(",")),
  ...
  class bB {
    constructor(e, t, n) {
        ...
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return oB(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(
                  nB(`Invalid value passed for the ${e} option`, o)
                ),
                !1);
          },
          a = (e) => ke(o, e);
          ...
          register: (e, n) => {
            const a = ((e) => m(e.processor))(n)
                ? ((e) => {
                    ...
                    return (n) => rB(n, t, `The value must be a ${e}.`);
                  })(n.processor)
                : n.processor,
              i = ((e, t, n) => {
                if (!v(t)) {
                  const o = rB(t, n);
                  if (oB(o)) return o.value;
                  console.error(
                    nB(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, n.default, a);
      ...
      C(d) && ma.DOM.styleSheetLoader._setContentCssCors(d),
        ...
        (this.inline = Pd(o)),
        (this.hasVisual = Wd(o)),
        (this.shortcuts = new mB(this)),
        (this.editorCommands = new FO(this)),
        LO(this);
    ...
    render() {
      ((e) => {
        ...
        va.setCode(dd(e));
        const n = () => {
          dO.unbind(window, "ready", n), e.render();
        };
        if (!na.Event.domLoaded) return void dO.bind(window, "ready", n);
        ...
        const s = e.getElement().form || dO.getParent(t, "form");
        s &&
          ((e.formElement = s),
          Dd(e) &&
            !lr(e.getElement()) &&
            (dO.insertAfter(dO.create("input", { type: "hidden", name: t }), t),
            (e.hasHiddenInput = !0)),
          (e.formEventDelegate = (t) => {
            e.dispatch(t.type, t);
          }),
          dO.bind(s, "submit reset", e.formEventDelegate),
          e.on("reset", () => {
            e.resetContent();
          }),
          !Ld(e) ||
          ...
          ((e) => "xml" === e.options.get("encoding"))(e) &&
            e.on("GetContent", (e) => {
              e.save && (e.content = dO.encode(e.content));
            }),
          Md(e) &&
            e.on("submit", () => {
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (gB.show(e.getContainer()), gB.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (gB.hide(e.getContainer()),
            gB.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    save(e = {}) {
      ...
      if (
        ...
        const o = gB.getParent(t.id, "form");
        o && hB(o.elements, (e) => e.name !== t.id || ((e.value = r), !1));
      }
      return (
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || gB.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = gB.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
  ...
  const xB = (e) => {
    ...
    kB = (e) => {
      if (e !== wB) {
        const t = ma.DOM;
        e
          ? (t.bind(window, "resize", xB), t.bind(window, "scroll", xB))
          : (t.unbind(window, "resize", xB), t.unbind(window, "scroll", xB)),
          (wB = e);
      }
    },
    _B = (e) => {
      ...
      return (
        (EB = Y(EB, (t) => e !== t)),
        NB.activeEditor === e &&
          (NB.activeEditor = EB.length > 0 ? EB[0] : null),
        NB.focusedEditor === e && (NB.focusedEditor = null),
        t.length !== EB.length
      );
    },
    SB = "CSS1Compat" !== document.compatMode,
    NB = {
      ...YO,
      baseURI: null,
      baseURL: null,
      ...
      createEditor(e, t) {
        return this.add(new bB(e, t, this));
      },
      remove(e) {
        const t = this;
        let n;
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(n.id))
                ? null
                : (_B(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === EB.length &&
        ...
        } else for (let e = EB.length - 1; e >= 0; e--) t.remove(EB[e]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
  ...
  const RB = (() => {
    ...
    PB = (e, t, n, o) => ({ x: e, y: t, w: n, h: o }),
    DB = {
      inflate: (e, t, n) => PB(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n),
      relativePosition: BB,
      ...
      intersect: (e, t) => {
        ...
        return r - n < 0 || s - o < 0 ? null : PB(n, o, r - n, s - o);
      },
      clamp: (e, t, n) => {
        let o = e.x,
          r = e.y,
      ...
      create: PB,
      fromClientRect: (e) => PB(e.left, e.top, e.width, e.height),
    },
    LB = (() => {
      const e = {},
        t = {},
  ...
  try {
    ...
    (MB = window.localStorage), MB.setItem(e, e), MB.removeItem(e);
  } catch (e) {
    MB = (() => {
      let e = {},
        t = [];
