...
<head>
    ...
    <title>Blog Post - Victory Fellowship Christian Information System</title>
...
<body>
    <nav class="navbar navbar-expand-lg fixed-top navbar-light" id="mainNav">
        <div class="container"><a class="navbar-brand" href="index.php">Victory Fellowship Christian Information System</a><button data-bs-toggle="collapse" data-bs-target="#navbarResponsive" class="navbar-toggler" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto position-relative">
                    <div class="post-heading">
                        <h1>Pagadian City Campus Hangout's</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    ...
                    <div class="row">
                        <div class="col text-center"><img class="img-fluid" src="assets/img/1.jpg" width="287" height="180"></div>
                    </div><a href="#"></a><span class="text-muted caption">To go places and do things that have never been done before – that’s what living is all about.</span>
