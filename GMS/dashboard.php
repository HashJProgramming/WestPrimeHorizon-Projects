...
<body>
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark navbar-custom">
        <div class="container"><a class="navbar-brand" href="#">TSNHSGMS - Tawagan Sur National High School Guidance Monitoring System</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navbarResponsive"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <div class="container-fluid py-4 py-xl-5">
        ...
        <div class="row gy-4 row-cols-1 row-cols-md-3 row-cols-xl-4">
            <div class="col">
                <div class="card border-primary border-2 h-100">
                    <div class="card-body d-flex flex-column justify-content-between p-4"><span class="badge bg-primary position-absolute top-0 end-0 rounded-bottom-left text-uppercase">GMS</span>
                        <div>
                            ...
                            <h4 class="display-6 fw-bold">OFFENSE</h4>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-between p-4">
                        <div>
                            <h6 class="text-uppercase text-muted">INFORMATION</h6>
                            <h4 class="display-6 fw-bold">SETTLED</h4>
                            <hr><a class="btn btn-primary d-block w-100" role="button" href="#" data-bs-target="#settle" data-bs-toggle="modal">ADD</a>
                            <hr>
                        </div><a class="btn btn-primary d-block w-100" role="button" href="#" data-bs-target="#view-settled" data-bs-toggle="modal">VIEW</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-between p-4">
                        <div>
                            ...
                            <hr>
                            <a class="btn btn-primary d-block w-100 mt-5" role="button" href="reports.php">VIEW</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="py-5 bg-black">
        <div class="container">
            <p class="text-center text-white m-0 small">Copyright&nbsp;© GMS - Guidance Monitoring System 2024</p>
        </div>
    </footer>
                ...
                <div class="modal-body">
                    <form class="text-center" action="functions/create-student.php" method="post">
                      ...
                      <div class="md-3" style="margin-bottom: 1rem;">
                        ...
                        <div class="mb-3"><input class="form-control" required  type="tel" minlength="11" maxlength="12"  pattern="[0-9]+" name="guardian_phone" placeholder="Guardian Phone"></div>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="settle">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Settle Student</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form class="text-center" action="functions/settle-violation.php" method="post">
                        <div class="mb-3"><input class="form-control" required  type="text"  pattern="^(?!\s).*$" name="violation_id" placeholder="Violation ID"></div>
                        <label for="sanctions" class="form-label">Sanctions</label>
                        <textarea class="mb-3 form-control" name="sanctions" pattern="^(?!\s).*$" cols="30" rows="5"></textarea>
                        <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit">Add Student</button></div>
                    </form>
                </div>
                <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="text-center" action="functions/update-student.php" method="post">
                        ...
                        <div class="mb-3"><input class="form-control" required  type="text"  pattern="^(?!\s).*$"name="fullname" placeholder="Fullname"></div>
                        <div class="mb-3"><input class="form-control" required  name="birthday" placeholder="birthday" type="date"></div>
                        <div class="mb-3">
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="view-settled">
        <div class="modal-dialog modal-fullscreen" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">View Settled</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-6">
                                <h3 class="text-dark mb-4">Settled List</h3>
                            </div>
                        </div>
                        <table class="table table-striped table tablesorter w-100" id="dataTable">
                            <thead class="thead-dark">
                                <tr>
                                    <th class="text-center">VIOLATION&nbsp;ID</th>
                                    <th class="text-center">STUDENT ID</th>
                                    ...
                                    <th class="text-center filter-false sorter-false">OFFENSE</th>
                                    <th class="text-center filter-false sorter-false">LEVEL</th>
                                    <th class="text-center filter-false sorter-false">SANCTIONS</th>
                                    <th class="text-center filter-false sorter-false">DATE</th>
                                </tr>
                            </thead>
                            <tbody class="text-center">
                                <?php include_once 'functions/settled-list.php';?>
                            </tbody>
                        </table>
                    </div>
                </div>
