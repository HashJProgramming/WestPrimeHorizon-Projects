...
$sql = 'SELECT *, DATE_FORMAT(created_at, "%Y-%m-%d %h:%i %p") AS created_at FROM violations WHERE sanctions != ""';
$stmt = $db->prepare($sql);
$stmt->execute();
    ...
    ?>
     <tr>
        ...
        ?>
            ...
            <td class="border-0 align-middle"><strong><?php echo $row['sanctions']; ?></strong></td>
